...
-- Add the new problem statement for our application
INSERT INTO problems (question, data) VALUES
('Calculate the number of employees who are younger than each employee, grouped by their respective departments. For each employee, return the count of employees in the same department whose age is less than theirs.', NULL);
